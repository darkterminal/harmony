...
namespace Harmony\Support\Commands;

use Harmony\Support\Commands\HelperCommands\HelperCommand;
...
class GeneratorPasswordController extends Command
{
    protected $commandName = 'make:auth-password';
    protected $commandDescription = "Create Password Authentication Scaffolding for your application";
    ...
    {
        $pagename = 'PasswordController';
        $controllerName = 'app/Controllers/Auth/'.$pagename.".php";
        $newFileContent = HelperCommand::getFileAuth('PasswordController', $pagename);
